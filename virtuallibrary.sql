...
-- Volcando estructura para tabla information_schema.THREAD_POOL_GROUPS
...
-- Volcando estructura para tabla information_schema.THREAD_POOL_QUEUES
...
-- Volcando estructura para tabla information_schema.THREAD_POOL_STATS
...
-- Volcando estructura para tabla information_schema.THREAD_POOL_WAITS
...
-- Volcando estructura para tabla virtual_library.biblioteca
CREATE TABLE IF NOT EXISTS `biblioteca` (
  `id` int(11) NOT NULL,
  `id_libro` int(11) NOT NULL,
  `id_username` int(11) NOT NULL,
  `comentario` varchar(100) NOT NULL,
  `meta_lectura` int(11) NOT NULL,
  `fecha_seleccion` datetime NOT NULL,
  `fecha_inicio` datetime NOT NULL,
  `fecha_fin` datetime NOT NULL,
  `novedad` tinyint(4) NOT NULL,
  `calificacion` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_libro` (`id_libro`),
  KEY `FK_usuario` (`id_username`),
  CONSTRAINT `FK_libro` FOREIGN KEY (`id_libro`) REFERENCES `libro` (`id_libro`),
  CONSTRAINT `FK_usuario` FOREIGN KEY (`id_username`) REFERENCES `usuario` (`id_username`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- La exportación de datos fue deseleccionada.

-- Volcando estructura para tabla virtual_library.libro
CREATE TABLE IF NOT EXISTS `libro` (
  `id_libro` int(11) NOT NULL DEFAULT 0,
  `titulo` varchar(150) DEFAULT NULL,
  `genero` varchar(100) DEFAULT NULL,
  `autor` varchar(100) DEFAULT NULL,
  `yearpublication` int(4) DEFAULT NULL,
...
-- Volcando estructura para tabla virtual_library.usuario
CREATE TABLE IF NOT EXISTS `usuario` (
  `id_username` int(11) NOT NULL DEFAULT 0,
